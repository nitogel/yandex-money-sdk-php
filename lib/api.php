...
class API extends BaseAPI
{
    ...
    {
        return $this->sendAuthenticatedRequest("/api/token-aux", [
            "scope" => implode(" ", $scope)
        ]);
    }
     ...
     * @return response object
     */
    function operationHistory(array $options = [])
    {
    ...
    public static function getAccessToken(
        ...
        return self::sendRequest($full_url, [
            "code"          => $code,
            "client_id"     => $client_id,
    ...
    {
        return self::sendRequest("/api/revoke", [
